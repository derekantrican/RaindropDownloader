...
Console app (.NET) that authenticates with Raindrop.io using a test token, fetches YouTube bookmarks, and downloads them using [YoutubeExplode](https://github.com/Tyrrrz/YoutubeExplode).
